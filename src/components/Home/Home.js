            ...
            <div className="intro md:flex mb-3">
                <div className=" lg:w-6/12 md:w-6/12 sm:w-full w-full p-3 flex items-center justify-center">
                    <div>
                        ...
                        <p className='my-3 text-lg'>We are the Leading pure Honey provider in the Uk.We have Big Consumer Network which is built by Our Reputation.We did not compromise the quality of our products from establishment.So you keep trust on us..</p>
